...
public enum Option {
    ...
    PRINT_DEPS {
        ...
        void action() {
            try(Connection con = DriverManager.getConnection("jdbc:h2:file:/D:/_IdeaProjects/services for testing/Office/Office")){
    ...
    PRINT_EMPLOYEES {
        ...
        void action() {
            try(Connection con = DriverManager.getConnection(getProperty("db.url"))){
